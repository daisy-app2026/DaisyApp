...
import { getTalkToPastSystemPrompt } from '../src/config/systemPrompt'
...
async function runTest() {
  try {
    ...
    const systemPrompt = getTalkToPastSystemPrompt("Alex", answers)

    const messages = [
      { role: 'user' as const, content: "Hi Alex, how have you been?" }
    ]
